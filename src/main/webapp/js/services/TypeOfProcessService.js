...
this.sendcustsubData=function(submiteedlistvalues,id){
	debugger;
	console.log("hi");
	$http({
		method:'POST',
...
this.sendCustrejectedData=function(custrejectvalues,id){
	console.log("hi");
	$http({
		method:'POST',
		url:'rest/addCandidate/update/'+id,
