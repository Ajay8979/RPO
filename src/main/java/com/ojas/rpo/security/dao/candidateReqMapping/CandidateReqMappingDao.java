...
public interface CandidateReqMappingDao extends Dao<CandidateMapping, Long> {
	...
	List<CandidateMapping> getCandiateMapCandedateId(Long candidateId);

	Response getCandidatesList(String role, Long loginid, Integer pageNo, Integer pageSize, String sortingOrder, String sortingField, String searchText, String searchField);
	
	Response searchCandidatesList(String role, Long id, String searchInput, String searchField, Integer pageNo, Integer pageSize);
