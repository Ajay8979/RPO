...
public class Client implements Entity {
	...
	@ManyToOne
	private User accountManger;
	

	public User getAccountManger() {
		return accountManger;
	}

	public void setAccountManger(User accountManger) {
	...
	public String toString() {
		return "Client [id=" + id + ", clientName=" + clientName + ", date=" + date + ", date1=" + date1 + ", phone="
				...
				+ ", tdspercentage=" + tdspercentage + ", secondaryContact=" + secondaryContact + ", primaryContact="
				+ primaryContact + ", paymentTerms=" + paymentTerms + ", services=" + services + ", addressDetails="
