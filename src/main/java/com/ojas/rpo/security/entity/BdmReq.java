...
public class BdmReq implements Entity {
	 ...
	 * "REQ_ID", referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name
	 * = "LOCATION_ID", referencedColumnName = "ID")) private List<Location>
	...
	private List<Certificate> certificates = new ArrayList<Certificate>();
	 ...
	 @ManyToMany
	  ...
	  @JoinTable(name = "recuriterMap", joinColumns = @JoinColumn(name =
	 "Assign_ID", referencedColumnName = "ID") , inverseJoinColumns
	  = @JoinColumn(name = "recuriter_ID", referencedColumnName = "ID") ) private
	 List<User> recrutier = new ArrayList<User>();
	 
	
	 
	  public List<User> getRecrutier() { return recrutier; }
	  
	 public void setRecrutier(List<User> recrutier) { this.recrutier = recrutier;
	  }
