...
public class MailGenaration {
	...
	public boolean sendSpecificMail(Candidate candidate) {

		String toAddress = "";
		String mailBody = "";
		String mailsubject = "";
		if (candidate.getCandidateStatus().equalsIgnoreCase("Aproved By AM")) {
			mailsubject = "Aproved By AM";
			toAddress = candidate.getUser().getEmail();
			mailBody = candidate.getFirstName() + " " + candidate.getLastName() + " Resume was Approved";
			sendMail(toAddress, mailBody, mailsubject);
			return true;
		} else if (candidate.getCandidateStatus().equalsIgnoreCase("AM Rejected")) {
			mailsubject = "Rejected by AM";
			toAddress = candidate.getUser().getEmail();
			mailBody = candidate.getFirstName() + " " + candidate.getLastName() + " Resume was Rejected";
			sendMail(toAddress, mailBody, mailsubject);

			return true;
		}

		else if (candidate.getCandidateStatus().equalsIgnoreCase("ReviewPending")) {
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Submitted to Customer")) {
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Customer Shortlisted")) {
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Customer Rejected")) {
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Offer Released")) {
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Candidate OfferAccepted")) {
			HashMap<String, String> mailList = null;
			InternetAddress[] address = null;
		...
		else if (candidate.getCandidateStatus().equalsIgnoreCase("Candidate OfferRejected")) {
			HashMap<String, String> mailList = null;
			InternetAddress[] address = null;
