app.controller('CandidatelistController', function($scope,
	...
	$scope.fun1=function() {
		debugger;
		var promise = CandidatelistServices.getCandidateData($scope.getrole,$scope.getuserid,$scope.pageIndex,$scope.pageSizeSelected,$scope.by,$scope.order,$scope.searchtext,$scope.searchcategory);
...
//		
		console.log("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",$rootScope.candidatelist);
	});
...
/*	$scope.searchsub=function(searchitem) {
		...
		$http.get("rest/candidateReqMapping/searchCandidatesList/"+$scope.getrole+"/"+$scope.getuserid+"/"+$scope.searchtext+"/"+$scope.searchcategory+"/"+$scope.pageIndex+"/"+$scope.pageSizeSelected).success(function(response){
			 ...
			 console.log("Submission list",$scope.candidatelist);
		});
...
$scope.fun1();		
	...
	$scope.submitStatus=function(){
		...
		$http.post('rest/addCandidate/confirmBoardStatus',onboardStatus).then(function(response){
